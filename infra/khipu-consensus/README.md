...
The full khipu-consensus (BFT quorum) sources that used to be vendored here have been removed.
...
**Canonical source: https://github.com/szl-holdings/khipu-consensus**
