...
The full vsp-otel (OpenTelemetry / Verifiable Span Provenance) sources that used to be vendored here have been removed.
...
**Canonical source: https://github.com/szl-holdings/vsp-otel**
