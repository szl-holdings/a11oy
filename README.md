...
[![SLSA L1 honest](https://img.shields.io/badge/SLSA-L1%20honest-2C5F2D?style=flat-square)](.compliance/SLSA_LEVEL.md)
...
# 2. Verify the cosign keyless signature on the published image (SLSA L1 honest).
#    GHCR verification shows a cosign-signed image (L1); L2 (an isolated, attested
#    build-service provenance for the deployed image, verifiable downstream) is
#    roadmap via Wire D and NOT yet claimed. See .compliance/SLSA_LEVEL.md.
...
| Supply-chain provenance | — | ✅ **cosign-signed (SLSA L1 honest)** | `cosign verify` on every image — they don't offer this. L2 roadmap via Wire D. |
...
| SLSA Build L1 honest | ✅ — cosign-signed image, verifiable via `cosign verify`; Rekor [1710578865](https://search.sigstore.dev/?logIndex=1710578865). L2 (attested build-service provenance for the deployed image) roadmap via Wire D — **not yet claimed**. See [.compliance/SLSA_LEVEL.md](.compliance/SLSA_LEVEL.md). |
...
<sub>Doctrine v11 LOCKED · 749/14/163 · kernel `c7c0ba17` · SLSA L1 honest (L2 roadmap, not yet claimed; L3 not claimed) · Λ = Conjecture 1 · Apache-2.0 · DOI [10.5281/zenodo.20434276](https://doi.org/10.5281/zenodo.20434276)</sub>
