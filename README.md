# A11oy
  ...
  > Orchestration control plane — design draft.
  ...
  A11oy is intended as the orchestration control plane: agent registry, validator policy, approval gate, and the surface where operators monitor and govern bounded-loop runs from the `@szl-holdings/ouroboros` package.
