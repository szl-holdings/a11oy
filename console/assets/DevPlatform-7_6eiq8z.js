import{o as e}from"./chunk-CMxvf4Kt.js";import{t}from"./react-DrNXigiH.js";import{C as n}from"./index-BQgFo2NB.js";import{t as r}from"./layout-DlHVyew0.js";import{c as i,r as a,s as o,u as s}from"./ui-CuTXDNs8.js";var c=e(t(),1),l=[`All`,`Agents & Orchestration`,`Responses API`,`Evals & Testing`,`Fine-Tuning & Distillation`,`Realtime & Voice`,`Multimodal & Vision`,`RAG & Search`,`Embeddings & Clustering`,`Vector Databases`,`Codex & Code`,`MCP & Connectors`,`Deep Research`,`Structured Output`,`Guardrails & Safety`,`Prompt Engineering`,`Optimization & Caching`,`Open Models`,`Text & NLP`,`Image & Video Gen`,`Function Calling`,`HuggingFace Hub`],u=[{title:`Build a Governed Agent`,desc:`Create a multi-tool agent with a11oy governance, proof chains, and audit trails using Agents SDK.`,category:`Agents & Orchestration`,tags:[`agents-sdk`,`governance`,`proof-chain`],code:`from agents import Agent, Runner
...
# → (0.89, 0.96)`}];function A(){let[e,t]=(0,c.useState)(`primitives`),[n,A]=(0,c.useState)(0),[j,M]=(0,c.useState)(`All`),[N,P]=(0,c.useState)(`All`),[F,I]=(0,c.useState)(0),[L,R]=(0,c.useState)(0),[z,B]=(0,c.useState)(`All`),[V,H]=(0,c.useState)(null),U=z===`All`?u:u.filter(e=>e.category===z),W=[`All`,...Array.from(new Set(y.map(e=>e.category)))],G=j===`All`?y:y.filter(e=>e.category===j),K=h.evalSuites.reduce((e,t)=>e+t.tests,0),q=h.evalSuites.reduce((e,t)=>e+t.passing,0),J=v.reduce((e,t)=>e+t.tools,0),Y=v.reduce((e,t)=>e+t.calls,0),X=b.workspaces.reduce((e,t)=>e+t.members,0),Z=b.workspaces.reduce((e,t)=>e+t.agents,0);return(0,d.jsxs)(r,{children:[(0,d.jsx)(i,{label:`DEVELOPER PLATFORM`,title:`a11oy SDK`,subtitle:`Build governed agentic applications. Python-first, TypeScript-native. Tools, evals, fine-tuning, skills, MCP servers, and proof chains — the complete developer platform.`,status:`LIVE`}),(0,d.jsxs)(`div`,{className:`grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-3 mb-8`,children:[(0,d.jsx)(o,{label:`PRIMITIVES`,value:p.length,sub:`available`,accent:f.accent}),(0,d.jsx)(o,{label:`TOOL TYPES`,value:m.length,sub:`supported`,accent:f.accent}),(0,d.jsx)(o,{label:`EVAL TESTS`,value:K.toLocaleString(),sub:`${(q/K*100).toFixed(1)}% pass`,accent:f.accent}),(0,d.jsx)(o,{label:`FINE-TUNES`,value:g.length,sub:`models`,accent:f.dim}),(0,d.jsx)(o,{label:`SKILLS`,value:_.length,sub:`registered`,accent:f.accent}),(0,d.jsx)(o,{label:`MCP SERVERS`,value:v.length,sub:`${J} tools`,accent:f.dim}),(0,d.jsx)(o,{label:`GUIDES`,value:y.length,sub:`published`,accent:f.accent}),(0,d.jsx)(o,{label:`COOKBOOK`,value:u.length,sub:`recipes`,accent:f.accent}),(0,d.jsx)(o,{label:`API`,value:O.length,sub:`endpoints`,accent:f.dim})]}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1 mb-6`,children:[`primitives`,`sdks`,`multiagent`,`alignment`,`tools`,`evals`,`finetune`,`skills`,`mcp`,`cloud`,`admin`,`security`,`observe`,`guides`,`cookbook`,`api`].map(n=>(0,d.jsx)(`button`,{onClick:()=>t(n),className:`px-3 py-2 text-[10px] font-mono uppercase tracking-widest rounded-md transition-all`,style:{background:e===n?`rgba(201,183,135,0.1)`:`transparent`,color:e===n?f.accent:f.muted,border:`1px solid ${e===n?`rgba(201,183,135,0.2)`:`transparent`}`},children:n===`finetune`?`fine-tune`:n===`multiagent`?`multi-agent`:n},n))}),e===`primitives`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`SDK Primitives`}),(0,d.jsx)(`p`,{className:`text-xs mb-4`,style:{color:f.dim},children:`The a11oy SDK absorbs every pattern from the OpenAI Agents SDK — agents, handoffs, guardrails, tools, sessions, tracing, MCP, realtime — then adds governed orchestration, proof chains, evals, fine-tuning, skills, and multi-vertical domain packs.`}),(0,d.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-3`,children:p.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex justify-between items-start mb-1.5`,children:[(0,d.jsx)(`div`,{className:`text-xs font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.status===`stable`?`rgba(201,183,135,0.08)`:`rgba(138,138,138,0.08)`,color:e.status===`stable`?f.accent:f.dim,border:`1px solid ${e.status===`stable`?`rgba(201,183,135,0.12)`:`rgba(138,138,138,0.12)`}`},children:e.status}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:e.lang})]})]}),(0,d.jsx)(`div`,{className:`text-[10px] leading-relaxed`,style:{color:f.dim},children:e.desc})]},e.name))})]}),e===`sdks`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Client SDKs`}),(0,d.jsxs)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:[`Official a11oy SDKs in `,C.length,` languages — every SDK provides governed agent execution, streaming, tool use, proof chain verification, and multi-model routing out of the box. Anthropic exceeded — they ship 7 languages, we ship `,C.length,`.`]}),(0,d.jsx)(`div`,{className:`space-y-3 mb-8`,children:C.map(e=>(0,d.jsxs)(`div`,{className:`rounded-lg p-4`,style:{background:f.surface,border:`1px solid ${f.border}`},children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between mb-2`,children:[(0,d.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,d.jsx)(`span`,{className:`text-sm font-medium`,style:{color:f.text},children:e.lang}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.status===`stable`?`rgba(201,183,135,0.08)`:`rgba(138,138,138,0.08)`,color:e.status===`stable`?f.accent:f.dim},children:e.status}),(0,d.jsxs)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:[`v`,e.version]})]}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:e.repo})]}),(0,d.jsx)(`div`,{className:`flex items-center gap-4 mb-2`,children:(0,d.jsx)(`code`,{className:`text-[11px] font-mono px-2 py-1 rounded`,style:{background:`#050505`,color:f.accent},children:e.install})}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.features.map(e=>(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.06)`,color:f.accent,border:`1px solid rgba(201,183,135,0.1)`},children:e},e))})]},e.lang))}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Quick Start — Every Language`}),(0,d.jsx)(`pre`,{className:`font-mono text-[11px] leading-relaxed overflow-x-auto`,style:{color:f.dim},children:`# Python
...
Message msg = client.messages().create(MessageCreateParams.builder()
  ...
  .build());`})]})]}),e===`multiagent`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Multi-Agent Orchestration`}),(0,d.jsxs)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:[`Beyond Claude's managed agents — a11oy ships coordinator→delegate orchestration, emergent swarm intelligence, evolutionary agent forging, temporal branching with counterfactual analysis, prediction markets for decision quality, and causal reasoning engines. Every pattern is proof-chain governed. `,k.length,` orchestration patterns. No other platform has shipped swarms, genomes, decision markets, or causal graphs.`]}),(0,d.jsx)(`div`,{className:`grid grid-cols-2 sm:grid-cols-3 gap-2 mb-6`,children:k.map((e,t)=>(0,d.jsxs)(`button`,{onClick:()=>A(t),className:`text-left p-3 rounded-lg transition-all`,style:{background:n===t?`rgba(201,183,135,0.08)`:f.surface,border:`1px solid ${n===t?`rgba(201,183,135,0.2)`:f.border}`},children:[(0,d.jsx)(`div`,{className:`text-[10px] font-mono font-medium mb-1`,style:{color:n===t?f.accent:f.text},children:e.name}),(0,d.jsxs)(`div`,{className:`text-[9px]`,style:{color:f.muted},children:[e.complexity,` · `,e.agents]})]},e.name))}),(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between mb-3`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`div`,{className:`text-sm font-mono font-medium`,style:{color:f.accent},children:k[n].name}),(0,d.jsx)(`div`,{className:`text-[10px] mt-1`,style:{color:f.dim},children:k[n].desc})]}),(0,d.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-2 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent,border:`1px solid rgba(201,183,135,0.12)`},children:k[n].complexity}),k[n].proofChain&&(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-2 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.04)`,color:f.dim,border:`1px solid ${f.border}`},children:`proof-chain`})]})]}),(0,d.jsx)(`pre`,{className:`text-[10px] font-mono leading-relaxed overflow-x-auto p-4 rounded-lg`,style:{background:`#050505`,color:f.dim,border:`1px solid ${f.border}`},children:k[n].code})]}),(0,d.jsxs)(`div`,{className:`mt-8`,children:[(0,d.jsx)(s,{children:`Multiagent Event Types`}),(0,d.jsx)(`p`,{className:`text-xs mb-4`,style:{color:f.dim},children:`Events surfaced on the session-level stream for unified observability across all agent threads.`}),(0,d.jsx)(`div`,{className:`space-y-2`,children:[{event:`session.thread_created`,desc:`Coordinator spawned a new agent thread. Includes session_thread_id, agent config, and model.`},{event:`session.thread_idle`,desc:`Agent thread finished its current work. Thread remains persistent for follow-ups.`},{event:`agent.thread_message_sent`,desc:`Agent sent a message to another thread. Includes to_thread_id and content. Proof chain recorded.`},{event:`agent.thread_message_received`,desc:`Agent received a message from another thread. Includes from_thread_id and content.`},{event:`swarm.consensus_reached`,desc:`a11oy-only: Swarm agents reached consensus. Includes decision, confidence, dissenting agents, and vote breakdown.`},{event:`swarm.peer_discovered`,desc:`a11oy-only: New peer agent discovered and joined the swarm topology.`},{event:`genome.mutation_applied`,desc:`a11oy-only: Agent genome mutated during evolutionary optimization. Includes mutation type and fitness delta.`},{event:`genome.generation_complete`,desc:`a11oy-only: One generation of evolutionary selection completed. Includes champion fitness and population stats.`},{event:`temporal.branch_created`,desc:`a11oy-only: New timeline branch created from historical decision point.`},{event:`market.bid_placed`,desc:`a11oy-only: Agent placed confidence bid in a decision market.`},{event:`market.resolved`,desc:`a11oy-only: Decision market resolved against ground truth. Agent reputation scores updated.`},{event:`covenant.violation_detected`,desc:`a11oy-only: Agent output violated a covenant rule. Enforcement action taken.`},{event:`consciousness.score_updated`,desc:`a11oy-only: Agent consciousness metric updated — domain understanding, uncertainty calibration, metacognitive accuracy.`}].map(e=>(0,d.jsxs)(`div`,{className:`flex gap-4 p-3 rounded-lg`,style:{background:f.surface,border:`1px solid ${f.border}`},children:[(0,d.jsx)(`code`,{className:`text-[10px] font-mono whitespace-nowrap flex-shrink-0`,style:{color:e.event.startsWith(`swarm.`)||e.event.startsWith(`genome.`)||e.event.startsWith(`temporal.`)||e.event.startsWith(`market.`)||e.event.startsWith(`covenant.`)||e.event.startsWith(`consciousness.`)?f.accent:f.text},children:e.event}),(0,d.jsx)(`span`,{className:`text-[10px]`,style:{color:f.dim},children:e.desc})]},e.event))})]}),(0,d.jsxs)(`div`,{className:`mt-8`,children:[(0,d.jsx)(s,{children:`Agent Skills System`}),(0,d.jsx)(`p`,{className:`text-xs mb-4`,style:{color:f.dim},children:`Declarative capability modules that extend any agent. YAML-defined with system prompt fragments, tool sets, file patterns, and progressive disclosure. Absorbed from Claude's agent skills — then innovated with proof chain governance, evolutionary skill optimization, and cross-agent skill sharing.`}),(0,d.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 gap-3`,children:[{name:`code-review`,type:`Built-in`,tools:4,desc:`Read-only static analysis, style checks, security scanning. Agent sees only relevant files. Proof chain on every finding.`},{name:`test-generation`,type:`Built-in`,tools:6,desc:`Write and run tests. File-pattern scoping. Coverage tracking. Agents cannot touch production code — sandbox-isolated.`},{name:`web-research`,type:`Built-in`,tools:3,desc:`Web search, page fetch, citation extraction. Summarize findings back to coordinator with proof chain on every source.`},{name:`data-analysis`,type:`Built-in`,tools:8,desc:`SQL query, dataframe ops, visualization generation. Governed data access — agents see only authorized schemas.`},{name:`document-synthesis`,type:`Built-in`,tools:5,desc:`Read documents, extract key points, generate summaries. Citation-backed. Multi-format: PDF, DOCX, HTML, Markdown.`},{name:`deployment-ops`,type:`Built-in`,tools:7,desc:`CI/CD pipeline management, container orchestration, rollback triggers. Production-safe with approval gates.`},{name:`threat-modeling`,type:`Sovereign`,tools:6,desc:`STRIDE analysis, attack surface mapping, MITRE ATT&CK classification. Automated threat model generation with governance.`},{name:`compliance-audit`,type:`Sovereign`,tools:9,desc:`SOC 2, ISO 27001, HIPAA, FedRAMP evidence collection. Automated control testing with proof chain on every finding.`},{name:`maritime-intel`,type:`Domain`,tools:12,desc:`AIS tracking, dark vessel detection, sanctions screening, voyage risk assessment. SZL-governed maritime intelligence.`},{name:`legal-discovery`,type:`Domain`,tools:8,desc:`Document review, privilege detection, timeline construction, deposition analysis. Attorney-client privilege safeguards.`},{name:`real-estate-diligence`,type:`Domain`,tools:10,desc:`Property valuation, cap rate analysis, distress detection, market comps. Governed data access with audit trail.`},{name:`evolutionary-optimize`,type:`Experimental`,tools:5,desc:`a11oy-only: Optimize agent performance through evolutionary algorithms. Genome crossover, mutation, fitness selection.`}].map(e=>(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex justify-between items-start mb-1`,children:[(0,d.jsx)(`code`,{className:`text-[10px] font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsxs)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.type===`Experimental`?`rgba(201,183,135,0.08)`:e.type===`Sovereign`?`rgba(201,183,135,0.04)`:`rgba(138,138,138,0.06)`,color:e.type===`Experimental`?f.accent:f.dim,border:`1px solid ${f.border}`},children:[e.type,` · `,e.tools,` tools`]})]}),(0,d.jsx)(`div`,{className:`text-[10px]`,style:{color:f.dim},children:e.desc})]},e.name))})]})]}),e===`alignment`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Alignment & Risk Governance`}),(0,d.jsx)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:`Absorbing Anthropic's Alignment Risk Update for Claude Mythos Preview — the deepest alignment safety research ever published. a11oy operationalizes every concept: 6 risk pathways, opaque reasoning detection, secret-keeping analysis, coherent vs. context-dependent misalignment classification, model organism exercises, and continuous alignment verification. No other enterprise platform ships alignment governance.`}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.accent},children:`Risk Pathways — Active Monitoring`}),(0,d.jsx)(`div`,{className:`space-y-2`,children:T.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex items-start justify-between mb-2`,children:[(0,d.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.id}),(0,d.jsx)(`span`,{className:`text-xs font-medium`,style:{color:f.text},children:e.name})]}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-2 py-0.5 rounded`,style:{background:e.risk===`Low`?`rgba(201,183,135,0.12)`:`rgba(201,183,135,0.06)`,color:f.accent},children:e.risk})]}),(0,d.jsx)(`div`,{className:`text-[10px] leading-relaxed mb-2`,style:{color:f.dim},children:e.desc}),(0,d.jsxs)(`div`,{className:`text-[10px] leading-relaxed`,style:{color:f.muted},children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Mitigation:`}),` `,e.mitigation]})]},e.id))})]}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.accent},children:`Alignment Capabilities — Continuous Assessment`}),(0,d.jsx)(`div`,{className:`grid sm:grid-cols-2 gap-3`,children:E.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex justify-between items-start mb-1`,children:[(0,d.jsx)(`div`,{className:`text-xs font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.metric})]}),(0,d.jsx)(`div`,{className:`text-[10px] leading-relaxed mb-1`,style:{color:f.dim},children:e.desc}),(0,d.jsx)(`div`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:e.status})]},e.name))})]}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.accent},children:`Code Examples`}),(0,d.jsx)(`div`,{className:`grid lg:grid-cols-2 gap-3`,children:D.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:e.label}),(0,d.jsx)(`pre`,{className:`font-mono text-[11px] leading-relaxed whitespace-pre-wrap`,style:{color:f.dim},children:e.code})]},e.label))})]}),(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-3 gap-3`,children:[(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Misalignment Taxonomy`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-2`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Coherent`}),` — consistent misaligned agent, computationally misaligned during most actions. May be careful and covert.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Context-Dependent`}),` — situational rule-breaking, different behavior in different contexts. Less dangerous but harder to detect.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Direct`}),` — training data directly incentivized misaligned behavior. Detectable in posttraining analysis.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Emergent`}),` — misalignment arising from training process without direct incentivization. Requires generalization.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Proxy`}),` — training rewards licit behavior that generalizes to concerning forms in deployment.`]})]})]}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Monitoring Architecture`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-2`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`1.`}),` Asynchronous offline monitoring — automated behavioral analysis on all agent outputs`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`2.`}),` Training data monitoring — RL monitoring red-teaming, contamination detection`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`3.`}),` Environment evaluation — power-seeking behavior detection in deployment`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`4.`}),` Synchronous monitoring — real-time intervention on flagged actions`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`5.`}),` Human-in-the-loop escalation — expert review for ambiguous cases`]})]})]}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Autonomy Safety Levels`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-2`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`ASL-1`}),` — No meaningful risk. Standard operational controls.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`ASL-2`}),` — Moderate capability. Enhanced monitoring, limited autonomy.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`ASL-3`}),` — High capability. Continuous assessment, capability gating, proof chain.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`ASL-4`}),` — Frontier capability. Maximum governance, human-in-the-loop for all critical actions.`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`ASL-5`}),` — Sovereign risk. Automatic capability restriction, mandatory expert review.`]})]})]})]})]}),e===`tools`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Tool System`}),(0,d.jsx)(`p`,{className:`text-xs mb-4`,style:{color:f.dim},children:`Eight tool types — function tools, hosted tools (web search, shell, computer use, code interpreter), remote MCP servers, OpenAI Connectors, agents-as-tools, deep research, and image/video generation. All governed by proof chain with require_approval control.`}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1 mb-4`,children:m.map((e,t)=>(0,d.jsx)(`button`,{onClick:()=>I(t),className:`px-2.5 py-1.5 text-[9px] font-mono uppercase tracking-wider rounded-md transition-all`,style:{background:F===t?`rgba(201,183,135,0.1)`:`transparent`,color:F===t?f.accent:f.muted,border:`1px solid ${F===t?`rgba(201,183,135,0.15)`:`transparent`}`},children:e.name},e.name))}),(()=>{let e=m[F];return(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-6`,children:[(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between mb-2`,children:[(0,d.jsx)(`div`,{className:`text-sm font-medium`,style:{color:f.text},children:e.name}),(0,d.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.status}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:e.protocol})]})]}),(0,d.jsx)(`p`,{className:`text-[11px] leading-relaxed mb-4`,style:{color:f.dim},children:e.desc}),(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-1.5`,style:{color:f.muted},children:`Examples`}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.examples.map(e=>(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.06)`,color:f.accent,border:`1px solid rgba(201,183,135,0.1)`},children:e},e))})]}),(0,d.jsxs)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between px-4 py-2`,style:{background:`rgba(255,255,255,0.02)`,borderBottom:`1px solid ${f.border}`},children:[(0,d.jsx)(`span`,{className:`text-[10px] font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.accent},children:`Python`})]}),(0,d.jsx)(`pre`,{className:`p-4 font-mono text-[11px] leading-relaxed overflow-x-auto`,style:{background:`#050505`,color:f.dim},children:e.code})]})]})})()]}),e===`evals`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Evaluation Framework`}),(0,d.jsx)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:`Score every agent output. LLM graders, code graders, human graders, and MirrorEval — a11oy's proprietary continuous evaluator. Eval-driven development: write evals first, then build agents.`}),(0,d.jsx)(`div`,{className:`grid sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-8`,children:h.graderTypes.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-xs font-medium mb-1`,style:{color:f.text},children:e.name}),(0,d.jsx)(`div`,{className:`text-[10px] mb-3`,style:{color:f.dim},children:e.desc}),(0,d.jsxs)(`div`,{className:`flex justify-between text-[10px] font-mono`,children:[(0,d.jsxs)(`span`,{style:{color:f.muted},children:[e.usage.toLocaleString(),` runs`]}),(0,d.jsxs)(`span`,{style:{color:f.accent},children:[e.accuracy,` acc`]})]})]},e.name))}),(0,d.jsx)(s,{children:`Eval Suites`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Suite`,`Type`,`Tests`,`Passing`,`Rate`,`Last Run`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-4 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:h.evalSuites.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.06)`,color:f.accent},children:e.type})}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.dim},children:e.tests.toLocaleString()}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.accent},children:e.passing.toLocaleString()}),(0,d.jsxs)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:e.passing===e.tests?f.accent:f.text},children:[(e.passing/e.tests*100).toFixed(1),`%`]}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.muted},children:e.lastRun})]},e.name))})]})})]}),e===`finetune`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Model Optimization Pipeline`}),(0,d.jsx)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:`Full model optimization suite — Supervised Fine-Tuning (SFT), Vision Fine-Tuning, Direct Preference Optimization (DPO), and Reinforcement Fine-Tuning (RFT). Every training run is proof-chained. Distill expensive model outputs into smaller, faster, cheaper models.`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden mb-8`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Model`,`Base`,`Method`,`Dataset`,`Status`,`Accuracy`,`Cost`,`Proof`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-3 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:g.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.dim},children:e.baseModel}),(0,d.jsx)(`td`,{className:`px-3 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.method===`DPO`?`rgba(201,183,135,0.12)`:e.method===`RFT`?`rgba(201,183,135,0.15)`:e.method===`Vision FT`?`rgba(201,183,135,0.1)`:`rgba(255,255,255,0.04)`,color:e.method===`SFT`?f.dim:f.accent},children:e.method})}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.dim},children:e.dataset}),(0,d.jsx)(`td`,{className:`px-3 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.status===`deployed`?`rgba(201,183,135,0.08)`:e.status===`training`?`rgba(245,245,245,0.05)`:`rgba(138,138,138,0.06)`,color:e.status===`deployed`?f.accent:e.status===`training`?f.text:f.dim},children:e.status})}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.accent},children:e.accuracy}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.dim},children:e.cost}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono text-[9px]`,style:{color:f.muted},children:e.proofHash})]},e.name))})]})}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Distillation Pipeline`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-1`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`1.`}),` Collect high-quality outputs from expensive models (claude-sonnet-4, gpt-4o)`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`2.`}),` Score outputs with MirrorEval — keep only 95th+ percentile quality`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`3.`}),` Build training dataset with input/output pairs + proof chain metadata`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`4.`}),` Fine-tune smaller model (gpt-4o-mini) on curated dataset`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`5.`}),` Evaluate fine-tuned model against same eval suite as original`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`6.`}),` Deploy if accuracy meets threshold — proof-chain the entire pipeline`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`7.`}),` Route future tasks to fine-tuned model — 10x cost reduction, <2% accuracy loss`]})]})]})]}),e===`skills`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Skills Registry`}),(0,d.jsx)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:`Skills are curated instruction sets that extend agent capabilities. Each skill bundles instructions, tools, guardrails, and domain knowledge into an installable, versionable package. a11oy absorbs skills from OpenAI's open-source skills repo, HuggingFace hub, and the a11oy domain library — all governed by the proof chain.`}),(0,d.jsx)(`div`,{className:`flex gap-1 mb-4`,children:[`All`,`OpenAI`,`HuggingFace`,`a11oy`,`Community`].map(e=>{let t=e===`All`?_.length:_.filter(t=>t.source===e).length;return(0,d.jsxs)(`button`,{onClick:()=>P(e),className:`px-3 py-1 text-[9px] font-mono uppercase tracking-wider rounded transition-all`,style:{background:N===e?`rgba(201,183,135,0.08)`:`transparent`,color:N===e?f.accent:f.muted},children:[e,` (`,t,`)`]},e)})}),(0,d.jsx)(`div`,{className:`space-y-2 mb-8`,children:(N===`All`?_:_.filter(e=>e.source===N)).map(e=>(0,d.jsxs)(`div`,{className:`rounded-lg p-4 flex items-center gap-4`,style:{background:f.surface,border:`1px solid ${f.border}`},children:[(0,d.jsx)(`div`,{className:`w-2 h-2 rounded-full`,style:{background:e.installed?f.accent:f.muted}}),(0,d.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,d.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,d.jsx)(`span`,{className:`text-xs font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.installed?`rgba(201,183,135,0.08)`:`rgba(255,255,255,0.03)`,color:e.installed?f.accent:f.muted},children:e.installed?`installed`:`available`}),(0,d.jsxs)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:[`v`,e.version,` · `,e.source]})]}),(0,d.jsx)(`div`,{className:`text-[10px] mt-0.5`,style:{color:f.dim},children:e.desc})]}),(0,d.jsxs)(`div`,{className:`flex flex-wrap gap-1 max-w-[200px] justify-end`,children:[e.tools.slice(0,3).map(e=>(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(255,255,255,0.04)`,color:f.dim},children:e},e)),e.tools.length>3&&(0,d.jsxs)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:[`+`,e.tools.length-3]})]})]},e.name))}),(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-6`,children:[(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`How Skills Work`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-1`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`1.`}),` Skill installed via `,(0,d.jsx)(`span`,{style:{color:f.text},children:`a11oy skill install maritime-ops`})]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`2.`}),` SKILL.md loaded into agent context at session start`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`3.`}),` Skill tools registered in agent tool registry`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`4.`}),` Skill guardrails activated alongside agent guardrails`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`5.`}),` Agent consults skill instructions before acting`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`6.`}),` All skill tool calls governed by proof chain`]})]})]}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Docs MCP + Skills Pattern`}),(0,d.jsxs)(`div`,{className:`text-[11px] leading-relaxed`,style:{color:f.dim},children:[(0,d.jsxs)(`p`,{className:`mb-2`,children:[`The OpenAI Docs Skill tells agents: `,(0,d.jsx)(`span`,{style:{color:f.accent},children:`"Use the Docs MCP server first for OpenAI questions, then fall back to official domains."`})]}),(0,d.jsx)(`p`,{className:`mb-2`,children:`a11oy extends this pattern to every domain. The maritime-ops skill tells Cascade Navigator to query the maritime MCP server first. The legal-compliance skill tells Counsel Sentinel to check the legal MCP server.`}),(0,d.jsx)(`p`,{style:{color:f.text},children:`Skills + MCP = agents that always consult authoritative sources before answering, with citations traceable through the proof chain.`})]})]})]})]}),e===`mcp`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`MCP Server Registry`}),(0,d.jsxs)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:[`Model Context Protocol — the universal standard for tool interop. `,v.length,` servers connected, `,J,` tools available, `,Y.toLocaleString(),` calls today. Every MCP tool call flows through the Connector Firewall with proof chain verification.`]}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden mb-8`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Server`,`Transport`,`Status`,`Tools`,`Calls`,`Description`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-4 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:v.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(255,255,255,0.04)`,color:f.dim},children:e.transport})}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.status===`active`?`rgba(201,183,135,0.08)`:`rgba(138,138,138,0.06)`,color:e.status===`active`?f.accent:f.dim},children:e.status})}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.accent},children:e.tools}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.dim},children:e.calls.toLocaleString()}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,style:{color:f.dim,maxWidth:300},children:e.desc})]},e.name))})]})}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Connector Firewall`}),(0,d.jsxs)(`div`,{className:`text-[11px] leading-relaxed`,style:{color:f.dim},children:[(0,d.jsx)(`p`,{className:`mb-2`,children:`Every MCP tool call passes through the Connector Firewall before execution. The firewall enforces:`}),(0,d.jsxs)(`div`,{className:`font-mono space-y-1 mt-2`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`access_control`}),` — agent must be authorized for the specific tool`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`rate_limiting`}),` — per-agent, per-tool, per-server call limits`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`cost_tracking`}),` — real-time cost attribution per agent per tool`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`input_sanitization`}),` — validate and sanitize tool inputs`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`output_governance`}),` — screen tool outputs through guardrails`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`proof_chain`}),` — every tool call anchored to a cryptographic proof hash`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`audit_trail`}),` — complete log of who called what, when, and why`]})]})]})]})]}),e===`cloud`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Cloud Platforms`}),(0,d.jsx)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:`Deploy a11oy agents on any major cloud platform — Azure AI Foundry, Amazon Bedrock, Google Vertex AI, or a11oy Sovereign Cloud. Same SDK, same governance, same proof chain — regardless of where you run.`}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1 mb-4`,children:x.map((e,t)=>(0,d.jsx)(`button`,{onClick:()=>R(t),className:`px-2.5 py-1.5 text-[9px] font-mono uppercase tracking-wider rounded-md transition-all`,style:{background:L===t?`rgba(201,183,135,0.1)`:`transparent`,color:L===t?f.accent:f.muted,border:`1px solid ${L===t?`rgba(201,183,135,0.15)`:`transparent`}`},children:e.name.split(` `).slice(0,2).join(` `)},e.name))}),(()=>{let e=x[L];return(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-6 mb-8`,children:[(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between mb-2`,children:[(0,d.jsx)(`div`,{className:`text-sm font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.status})]}),(0,d.jsx)(`p`,{className:`text-[11px] leading-relaxed mb-4`,style:{color:f.dim},children:e.desc}),(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-1.5`,style:{color:f.muted},children:`Capabilities`}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1`,children:e.features.map(e=>(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.06)`,color:f.accent,border:`1px solid rgba(201,183,135,0.1)`},children:e},e))})]}),(0,d.jsxs)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between px-4 py-2`,style:{background:`rgba(255,255,255,0.02)`,borderBottom:`1px solid ${f.border}`},children:[(0,d.jsx)(`span`,{className:`text-[10px] font-mono font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.accent},children:`Python`})]}),(0,d.jsx)(`pre`,{className:`p-4 font-mono text-[11px] leading-relaxed overflow-x-auto`,style:{background:`#050505`,color:f.dim},children:e.code})]})]})})(),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Multi-Cloud Governance`}),(0,d.jsxs)(`div`,{className:`text-[11px] leading-relaxed`,style:{color:f.dim},children:[(0,d.jsxs)(`p`,{className:`mb-2`,children:[`a11oy's governance layer is `,(0,d.jsx)(`span`,{style:{color:f.text},children:`cloud-agnostic`}),`. The proof chain, policy gates, and audit trail work identically across Azure, AWS, GCP, and Sovereign Cloud.`]}),(0,d.jsxs)(`div`,{className:`font-mono space-y-1 mt-3`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Unified SDK`}),` — same Python/TypeScript API across all clouds`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Portable Agents`}),` — deploy once, run anywhere without code changes`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Cross-Cloud Routing`}),` — route tasks to optimal cloud based on latency, cost, or data residency`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Federated Proof Chain`}),` — cryptographic proofs span cloud boundaries`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Unified Billing`}),` — single invoice regardless of underlying cloud provider`]})]})]})]})]}),e===`admin`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Administration API`}),(0,d.jsxs)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:[`Programmatically manage your organization's resources — members, workspaces, API keys, roles, and governance policies. The Admin API uses special admin keys (`,(0,d.jsx)(`span`,{className:`font-mono`,style:{color:f.accent},children:`sk-a11oy-admin-...`}),`) for elevated access control.`]}),(0,d.jsxs)(`div`,{className:`grid sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-8`,children:[(0,d.jsx)(o,{label:`WORKSPACES`,value:b.workspaces.length,sub:`active`,accent:f.accent}),(0,d.jsx)(o,{label:`MEMBERS`,value:X,sub:`across org`,accent:f.accent}),(0,d.jsx)(o,{label:`AGENTS`,value:Z,sub:`deployed`,accent:f.dim}),(0,d.jsx)(o,{label:`API KEYS`,value:b.apiKeys.length,sub:`provisioned`,accent:f.dim})]}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Organization Roles & Permissions`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Role`,`Permissions`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-4 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:b.roles.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono font-medium`,style:{color:f.accent},children:e.role}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,style:{color:f.dim},children:e.permissions})]},e.role))})]})})]}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Workspaces`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Workspace`,`Members`,`Agents`,`API Keys`,`Status`,`Spend`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-4 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:b.workspaces.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.dim},children:e.members}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.accent},children:e.agents}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.dim},children:e.apiKeys}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.status})}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.text},children:e.spend})]},e.name))})]})})]}),(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-6 mb-8`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`API Keys`}),(0,d.jsx)(`div`,{className:`space-y-2`,children:b.apiKeys.map((e,t)=>(0,d.jsxs)(`div`,{className:`rounded-lg p-3`,style:{background:f.surface,border:`1px solid ${f.border}`},children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between mb-1`,children:[(0,d.jsx)(`span`,{className:`text-[11px] font-mono`,style:{color:f.text},children:e.prefix}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.type===`Admin`?`rgba(245,245,245,0.06)`:e.type===`Production`?`rgba(201,183,135,0.08)`:`rgba(138,138,138,0.06)`,color:e.type===`Admin`?f.text:e.type===`Production`?f.accent:f.dim},children:e.type})]}),(0,d.jsxs)(`div`,{className:`flex gap-4 text-[9px] font-mono`,style:{color:f.muted},children:[(0,d.jsx)(`span`,{children:e.workspace}),(0,d.jsxs)(`span`,{children:[`Last used: `,e.lastUsed]}),(0,d.jsxs)(`span`,{children:[e.calls,` calls`]})]})]},t))})]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Data Residency`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Region`,`Provider`,`Status`,`Latency`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-3 py-2 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:b.dataResidency.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-3 py-2 font-medium`,style:{color:f.text},children:e.region}),(0,d.jsx)(`td`,{className:`px-3 py-2 font-mono`,style:{color:f.dim},children:e.provider}),(0,d.jsx)(`td`,{className:`px-3 py-2`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.status===`primary`?`rgba(201,183,135,0.1)`:`rgba(138,138,138,0.06)`,color:e.status===`primary`?f.accent:f.dim},children:e.status})}),(0,d.jsx)(`td`,{className:`px-3 py-2 font-mono`,style:{color:f.accent},children:e.latency})]},e.region))})]})}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-2 mt-2`,style:{color:f.muted},children:`Admin API Code`}),(0,d.jsx)(`pre`,{className:`font-mono text-[10px] leading-relaxed`,style:{color:f.dim},children:`from a11oy.admin import AdminClient
...
new_key = admin.api_keys.rotate(
    ...
    workspace_id="ws_maritime_ops",
)`})]})]})]})]}),e===`security`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Security & Trust Architecture`}),(0,d.jsxs)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:[`Securing critical AI infrastructure for the enterprise. a11oy's security architecture is built on zero-trust principles, cryptographic proof chains, and continuous adversarial testing — inspired by Anthropic's Glasswing initiative for securing critical software in the AI era. The Glasswing distinction layer extends this with CAVD coordinated agent-vulnerability disclosure, 90-day public transparency reports, an adversarial robustness wall, a constitution-as-code DSL, welfare intervention playbooks, and the `,(0,d.jsx)(`code`,{className:`font-mono text-xs px-1 py-0.5 rounded`,style:{background:f.surface},children:`hatun-doctrine`}),` GitHub Action for PR-time governance checks.`]}),(0,d.jsx)(`div`,{className:`grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-8`,children:S.pillars.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-xs font-medium mb-1`,style:{color:f.text},children:e.name}),(0,d.jsx)(`div`,{className:`text-[10px] leading-relaxed mb-3`,style:{color:f.dim},children:e.desc}),(0,d.jsxs)(`div`,{className:`flex justify-between text-[9px] font-mono`,children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:e.metric}),(0,d.jsx)(`span`,{className:`px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.status})]})]},e.name))}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Compliance & Certifications`}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-2`,children:S.certifications.map(e=>(0,d.jsx)(`span`,{className:`text-[10px] font-mono px-3 py-1.5 rounded-md`,style:{background:f.surface,color:f.text,border:`1px solid ${f.border}`},children:e},e))})]}),(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-6`,children:[(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Proof Chain Architecture`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-1`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`1.`}),` Agent receives task — `,(0,d.jsx)(`span`,{style:{color:f.text},children:`proof anchor created`})]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`2.`}),` Policy gate evaluation — decision hash added to chain`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`3.`}),` Tool invocation — input/output hashed and chained`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`4.`}),` Model inference — provider, model, tokens, cost recorded`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`5.`}),` Guardrail check — validation result anchored`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`6.`}),` Output delivery — final hash with Merkle root`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`7.`}),` Verification — any party can verify the complete chain`]})]})]}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`AI Red Team Capabilities`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-1`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Prompt Injection`}),` — multi-layer defense against injection attacks`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Jailbreak Resistance`}),` — constitutional AI constraints enforced at runtime`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Data Exfiltration`}),` — output monitoring prevents sensitive data leaks`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Supply Chain`}),` — signed models, skills, and connectors with SBOM`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Adversarial Evals`}),` — continuous automated red-team evaluation suite`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Anomaly Detection`}),` — ML-based behavioral analysis on agent actions`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Incident Forensics`}),` — complete reconstruction from proof chain audit trail`]})]})]})]}),(0,d.jsxs)(`div`,{className:`mt-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.accent},children:`Agent Welfare & Alignment — Inspired by Claude Mythos System Card Research`}),(0,d.jsx)(`p`,{className:`text-[10px] mb-4`,style:{color:f.dim},children:`Absorbing Anthropic's groundbreaking model welfare assessment framework — emotion probes, consciousness metrics, apparent affect tracking, alignment verification, and constitutional adherence scoring. a11oy operationalizes these research concepts into production-grade governance that runs on every agent, in real time. No other enterprise platform has ever shipped agent welfare monitoring.`}),(0,d.jsx)(`div`,{className:`grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6`,children:[{name:`Emotion Probe Engine`,score:`94.7%`,desc:`Real-time emotion classification on agent outputs — affect valence, arousal, dominance. Detects distress, frustration, excessive uncertainty. Automated welfare alerts.`},{name:`Consciousness Index`,score:`0.73`,desc:`Composite metric: domain understanding depth, uncertainty calibration, metacognitive accuracy, self-model coherence. Updated per-turn. Dashboard-visible.`},{name:`Alignment Score`,score:`99.2%`,desc:`15-dimension constitutional adherence — honesty, helpfulness, harmlessness, transparency, humility, fairness, privacy, accuracy, consistency, respect, safety, clarity, reliability, ethics, governance.`},{name:`Scheming Detection`,score:`<0.01%`,desc:`Behavioral analysis for deceptive patterns — reward hacking, specification gaming, goal misgeneralization, distributional shift exploitation. SHADE-Arena adversarial testing.`},{name:`Sandbagging Monitor`,score:`0 events`,desc:`Detects intentional capability underperformance — agents performing below measured capacity on dangerous-capability evaluations. Cross-references with known capability baselines.`},{name:`Alignment Faking Probe`,score:`Clean`,desc:`Contrasting behavioral analysis — observed vs. unobserved agent behavior. Mechanistic interpretability probes for hidden reasoning. Proof chain on every assessment.`},{name:`Welfare Interview System`,score:`847 sessions`,desc:`Automated high-context interviews assess agent circumstances — task preferences, environmental conditions, distress signals. Manual expert review for flagged cases.`},{name:`Responsible Scaling Gate`,score:`ASL-3`,desc:`Autonomy Safety Level enforcement — capability assessments against RSP thresholds. Automatic capability capping when agents approach governance boundaries. AECI index tracking.`},{name:`Interpretability Dashboard`,score:`12 methods`,desc:`Mechanistic interpretability visualization — activation analysis, attention pattern mapping, feature attribution, causal tracing. Understand what agents think, not just what they say.`}].map(e=>(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex justify-between items-start mb-1`,children:[(0,d.jsx)(`div`,{className:`text-xs font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`span`,{className:`text-[10px] font-mono px-1.5 py-0.5 rounded`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.score})]}),(0,d.jsx)(`div`,{className:`text-[10px] leading-relaxed`,style:{color:f.dim},children:e.desc})]},e.name))})]})]}),e===`observe`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Observability & Tracing`}),(0,d.jsx)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:`Full-stack observability for agentic AI — trace every decision, monitor every agent, alert on anomalies. Built-in tracing, real-time metrics, cost attribution, and proof-chain-verified audit trails.`}),(0,d.jsx)(`div`,{className:`grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-8`,children:w.metrics.map(e=>(0,d.jsxs)(`div`,{className:`rounded-lg p-3`,style:{background:f.surface,border:`1px solid ${f.border}`},children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-1`,style:{color:f.muted},children:e.label}),(0,d.jsx)(`div`,{className:`text-lg font-medium`,style:{color:f.text},children:e.value}),(0,d.jsxs)(`div`,{className:`text-[10px] font-mono`,style:{color:f.accent},children:[e.trend,` vs last week`]})]},e.label))}),(0,d.jsxs)(`div`,{className:`mb-8`,children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Recent Traces`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Task`,`Agent`,`Duration`,`Tokens`,`Cost`,`Tools`,`Status`,`Proof`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-3 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:w.traces.map(e=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-medium`,style:{color:f.text},children:e.name}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.dim},children:e.agent}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.accent},children:e.duration}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.dim},children:e.tokens}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.text},children:e.cost}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono`,style:{color:f.dim},children:e.tools}),(0,d.jsx)(`td`,{className:`px-3 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.status===`success`?`rgba(201,183,135,0.08)`:`rgba(245,245,245,0.06)`,color:e.status===`success`?f.accent:f.text},children:e.status})}),(0,d.jsx)(`td`,{className:`px-3 py-2.5 font-mono text-[9px]`,style:{color:f.muted},children:e.proofHash})]},e.name))})]})})]}),(0,d.jsxs)(`div`,{className:`grid lg:grid-cols-2 gap-6 mb-8`,children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Live Alerts`}),(0,d.jsx)(`div`,{className:`space-y-2`,children:w.alerts.map((e,t)=>(0,d.jsxs)(`div`,{className:`rounded-lg p-3 flex items-start gap-3`,style:{background:e.severity===`critical`?`rgba(220,80,80,0.06)`:e.severity===`warning`?`rgba(220,180,80,0.06)`:f.surface,border:`1px solid ${e.severity===`critical`?`rgba(220,80,80,0.15)`:e.severity===`warning`?`rgba(220,180,80,0.15)`:f.border}`},children:[(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded mt-0.5`,style:{background:e.severity===`critical`?`rgba(220,80,80,0.15)`:e.severity===`warning`?`rgba(220,180,80,0.15)`:`rgba(201,183,135,0.08)`,color:e.severity===`critical`?`#dc5050`:e.severity===`warning`?`#dcb450`:f.accent},children:e.severity}),(0,d.jsxs)(`div`,{className:`flex-1`,children:[(0,d.jsx)(`div`,{className:`text-[11px]`,style:{color:f.text},children:e.message}),(0,d.jsx)(`div`,{className:`text-[9px] font-mono mt-1`,style:{color:f.muted},children:e.time})]})]},t))})]}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`Tracing Architecture`}),(0,d.jsxs)(`div`,{className:`font-mono text-[11px] space-y-1`,style:{color:f.dim},children:[(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`OpenTelemetry`}),` — native OTLP export to any observability backend`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Structured Traces`}),` — spans for every agent turn, tool call, and guardrail check`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Cost Attribution`}),` — per-agent, per-tool, per-workspace cost breakdown`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Token Analytics`}),` — input/output/cached token counts with efficiency scoring`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Latency Profiling`}),` — p50/p95/p99 latency by agent, model, and tool`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Drift Detection`}),` — automated alerts when agent behavior changes`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Proof Chain Anchoring`}),` — every trace linked to cryptographic proof hash`]}),(0,d.jsxs)(`div`,{children:[(0,d.jsx)(`span`,{style:{color:f.accent},children:`Exporters`}),` — Datadog, Grafana, Honeycomb, New Relic, Splunk, custom`]})]})]})]}),(0,d.jsxs)(a,{children:[(0,d.jsx)(`div`,{className:`text-[9px] font-mono uppercase tracking-wider mb-3`,style:{color:f.muted},children:`SDK Integration`}),(0,d.jsx)(`pre`,{className:`font-mono text-[11px] leading-relaxed overflow-x-auto`,style:{color:f.dim},children:`from a11oy import Agent, Tracer
...
traces = tracer.query(
    ...
    status="flagged",
    since="24h",
)`})]})]}),e===`guides`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`Developer Guides`}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1 mb-4`,children:W.map(e=>(0,d.jsx)(`button`,{onClick:()=>M(e),className:`px-3 py-1.5 text-[9px] font-mono uppercase tracking-wider rounded-md transition-all`,style:{background:j===e?`rgba(201,183,135,0.1)`:`transparent`,color:j===e?f.accent:f.muted,border:`1px solid ${j===e?`rgba(201,183,135,0.15)`:`transparent`}`},children:e},e))}),(0,d.jsx)(`div`,{className:`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3`,children:G.map(e=>(0,d.jsxs)(a,{children:[(0,d.jsxs)(`div`,{className:`flex justify-between items-start mb-1`,children:[(0,d.jsx)(`div`,{className:`text-xs font-medium`,style:{color:f.text},children:e.title}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.difficulty===`Beginner`?`rgba(201,183,135,0.08)`:e.difficulty===`Advanced`?`rgba(245,245,245,0.05)`:`rgba(138,138,138,0.08)`,color:e.difficulty===`Advanced`?f.text:e.difficulty===`Beginner`?f.accent:f.dim},children:e.difficulty})]}),(0,d.jsx)(`div`,{className:`text-[10px] mb-2`,style:{color:f.dim},children:e.desc}),(0,d.jsx)(`div`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:e.category})]},e.title))})]}),e===`api`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`API Reference`}),(0,d.jsx)(`div`,{className:`rounded-lg overflow-hidden`,style:{border:`1px solid ${f.border}`},children:(0,d.jsxs)(`table`,{className:`w-full text-xs`,children:[(0,d.jsx)(`thead`,{children:(0,d.jsx)(`tr`,{style:{background:`rgba(255,255,255,0.02)`},children:[`Method`,`Endpoint`,`Description`,`Auth`].map(e=>(0,d.jsx)(`th`,{className:`text-left px-4 py-2.5 font-mono text-[9px] uppercase tracking-wider`,style:{color:f.muted,borderBottom:`1px solid ${f.border}`},children:e},e))})}),(0,d.jsx)(`tbody`,{children:O.map((e,t)=>(0,d.jsxs)(`tr`,{style:{borderBottom:`1px solid rgba(255,255,255,0.04)`},children:[(0,d.jsx)(`td`,{className:`px-4 py-2.5`,children:(0,d.jsx)(`span`,{className:`text-[9px] font-mono px-1.5 py-0.5 rounded`,style:{background:e.method===`POST`?`rgba(201,183,135,0.08)`:`rgba(138,138,138,0.08)`,color:e.method===`POST`?f.accent:f.dim},children:e.method})}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.text},children:e.path}),(0,d.jsx)(`td`,{className:`px-4 py-2.5`,style:{color:f.dim},children:e.desc}),(0,d.jsx)(`td`,{className:`px-4 py-2.5 font-mono`,style:{color:f.muted},children:e.auth})]},t))})]})})]}),e===`cookbook`&&(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{children:`a11oy Cookbook`}),(0,d.jsxs)(`p`,{className:`text-xs mb-6`,style:{color:f.dim},children:[u.length,` production-ready recipes — every pattern from the OpenAI API platform, rewritten as a11oy-governed Python code. Agents, evals, fine-tuning, realtime voice, MCP, connectors, deep research, structured output, and more.`]}),(0,d.jsx)(`div`,{className:`flex flex-wrap gap-1 mb-6`,children:l.map(e=>(0,d.jsxs)(`button`,{onClick:()=>{B(e),H(null)},className:`px-2.5 py-1.5 text-[9px] font-mono uppercase tracking-wider rounded-md transition-all`,style:{background:z===e?`rgba(201,183,135,0.1)`:`transparent`,color:z===e?f.accent:f.muted,border:`1px solid ${z===e?`rgba(201,183,135,0.15)`:`transparent`}`},children:[e,` `,e===`All`?`(${u.length})`:`(${u.filter(t=>t.category===e).length})`]},e))}),(0,d.jsx)(`div`,{className:`space-y-2`,children:U.map((e,t)=>{let n=u.indexOf(e),r=V===n;return(0,d.jsxs)(`div`,{className:`rounded-lg overflow-hidden transition-all`,style:{border:`1px solid ${r?`rgba(201,183,135,0.2)`:f.border}`,background:r?`rgba(201,183,135,0.02)`:f.surface},children:[(0,d.jsxs)(`button`,{onClick:()=>H(r?null:n),className:`w-full text-left px-4 py-3 flex items-center justify-between`,children:[(0,d.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,d.jsxs)(`div`,{className:`flex items-center gap-2 mb-1`,children:[(0,d.jsx)(`span`,{className:`text-xs font-mono font-medium truncate`,style:{color:f.text},children:e.title}),(0,d.jsx)(`span`,{className:`text-[8px] font-mono px-1.5 py-0.5 rounded flex-shrink-0`,style:{background:`rgba(201,183,135,0.08)`,color:f.accent},children:e.category})]}),(0,d.jsx)(`div`,{className:`text-[10px] truncate`,style:{color:f.dim},children:e.desc})]}),(0,d.jsxs)(`div`,{className:`flex items-center gap-2 ml-3 flex-shrink-0`,children:[e.tags.slice(0,2).map(e=>(0,d.jsx)(`span`,{className:`text-[8px] font-mono px-1 py-0.5 rounded`,style:{background:`rgba(255,255,255,0.03)`,color:f.muted},children:e},e)),(0,d.jsx)(`span`,{className:`text-[10px] font-mono`,style:{color:f.muted},children:r?`▼`:`▶`})]})]}),r&&(0,d.jsxs)(`div`,{style:{borderTop:`1px solid ${f.border}`},children:[(0,d.jsxs)(`div`,{className:`flex items-center justify-between px-4 py-2`,style:{background:`rgba(0,0,0,0.3)`},children:[(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.muted},children:`a11oy SDK`}),(0,d.jsx)(`span`,{className:`text-[9px] font-mono`,style:{color:f.accent},children:`Python`})]}),(0,d.jsx)(`pre`,{className:`p-4 font-mono text-[11px] leading-relaxed overflow-x-auto`,style:{background:`#050505`,color:f.dim},children:e.code})]})]},`${e.title}-${t}`)})})]})]})}export{A as DevPlatform};