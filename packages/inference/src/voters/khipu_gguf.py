...
KHIPU_LAB_DEFAULT_BASE = "https://szlholdings-szl-model-inference-lab.hf.space"
...
def khipu_lab_base() -> str:
    """CPU lab origin. Tests may override with A11OY_KHIPU_LAB_BASE."""
    return os.environ.get("A11OY_KHIPU_LAB_BASE", KHIPU_LAB_DEFAULT_BASE).rstrip("/")
...
class KhipuGGUFVoter(BaseVoter):
    ...
    async def _call(
        ...
        **kwargs: Any,
        ...
        url = khipu_lab_base() + "/v1/chat/completions"
