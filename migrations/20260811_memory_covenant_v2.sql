...
-- RLS context to it. Refuse to bless pre-seeded authorization data. A prior
-- application is authenticated by trusted ownership plus the complete helper
-- catalog contract; a source-code substring is not migration provenance.
DO $$
DECLARE
