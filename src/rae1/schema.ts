 ...
 *
 * Doctrine v11 — no fake lake-green, no new axioms.
...
export interface RAE1Payload {
   ...
   *
   * Doctrine v11: "sorry_undisclosed" is FORBIDDEN and will cause validation failure.
   *
   * - "green": all proofs complete, 0 sorries
   * - "sorry_disclosed": sorries present but named and documented with discharge routes
   * - "sorry_undisclosed": FORBIDDEN by Doctrine v11
