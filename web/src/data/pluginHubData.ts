...
export const PLUGIN_CATEGORIES: PluginCategory[] = [
  ...
  },
  {
    ...
    count: 16,
    plugins: [
      { icon: '✨', name: 'A11oy Intelligence', desc: 'Decision Intelligence command — finance terminal, deep dive, ROI lens. Absorbs former Intelligence surface', tier: 'core', tags: ['decision', 'intelligence', 'kora'] },
