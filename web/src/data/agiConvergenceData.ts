// VENDORED FROM szl-holdings/platform@de08cf8ec5836b0cef968d6560a92ecbd1bc6f4b — artifacts/a11oy/src/data/agiConvergenceData.ts
...
export const COMPETITORS: CompetitorProfile[] = [
  ...
  },
  {
    ...
    absorbed: [
      'vLLM recipes — model config templates → a11oy Governed Agent Change Management Recipes (with Covenant + Proof Chain)',
...
export const ABSORBED_REPOS: AbsorbedCapability[] = [
  ...
  { source: 'vLLM', repo: 'vllm-project/vllm', stars: '42k', capability: 'High-throughput LLM serving + recipes', a11oyEquivalent: 'a11oy Governed Agent Change Management Recipes — model + task + domain + Covenant + Proof Chain', governed: true, status: 'surpassed' },
];
