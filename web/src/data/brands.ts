// VENDORED FROM szl-holdings/platform@d487e5f1e702c13c59509448a80b5da2e5751ea2 — artifacts/a11oy/src/data/brands.ts
...
// DEMO DATA (doctrine v11): this entire Atlas brand dataset is a staged demo
// walkthrough — scores, audits, and activity are illustrative, NOT measured.
// The Atlas UI labels this surface DEMO (amber). Never present these as real.
export const BRANDS_DATA_SOURCE = 'DEMO' as const;

const demoActivity = [
  { date: '2 hours ago', action: 'Token update applied', actor: 'System', surface: 'Web App' },
  {
    date: '1 day ago',
    action: 'Voice audit completed',
    actor: 'Brand Ops',
  ...
  szl: [
    {
      id: 'tenax',
      name: 'TENAX',
      tagline: 'TENAX — Cyber Resilience Command',
      color: '#8a8a8a',
      healthScore: 87,
    ...
    },
    {
      id: 'terra',
      name: 'DOMAINE',
      tagline: 'DOMAINE — Real Estate Intelligence',
      color: '#8a8a8a',
      healthScore: 68,
    ...
    },
    {
      id: 'vessels',
      name: 'SEXTANT',
      tagline: 'SEXTANT — Maritime Intelligence',
      color: '#c9b787',
      healthScore: 82,
