...
"""
a11oy_canonical_domain.py — make a11oy.com the single canonical host.
...
path+query on https://a11oy.com. The canonical HF Space host
(szlholdings-a11oy.hf.space), localhost, and a11oy.com itself are passed through
...
def register(app):
    """Install the a11oy.net -> a11oy.com 301 redirect middleware. Returns a status list."""
