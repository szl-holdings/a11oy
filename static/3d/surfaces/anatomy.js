...
//
// surfaces/anatomy.js — Anatomy · Loop surface STUB (Dev0 foundation; Dev8 fills this).
//
// Leader/technique to model: Microsoft Holograph + TSL
// Primary live endpoint (doctrine: WIRE TO LIVE DATA, never fabricate): /api/a11oy/v1/anatomy/loop
//
...
function mount(ctx) {
  ...
  h.textContent = TITLE + "  ·  awaiting Dev8";
  ...
  _handle = ctx.live.poll(ENDPOINT, 5000, (json, meta) => {
    // Dev8: replace with the real viz update. Honesty label is in meta.label.
