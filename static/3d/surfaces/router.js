...
//
// surfaces/router.js — Model Router surface STUB (Dev0 foundation; Dev7 fills this).
//
// Leader/technique to model: OpenRouter + RouteLLM
// Primary live endpoint (doctrine: WIRE TO LIVE DATA, never fabricate): /api/a11oy/v1/router/active-flux-crossover
//
...
//
// This STUB renders an honest "awaiting Dev7" placeholder + a LIVE badge wired to the
// real endpoint, proving the toolkit primitives work end-to-end before the real viz lands.

const ID = "router";
const TITLE = "Model Router";
const ENDPOINT = "/api/a11oy/v1/router/active-flux-crossover";
const ACCENT = 0x39d3c4;
...
function mount(ctx) {
  ...
  h.textContent = TITLE + "  ·  awaiting Dev7";
  ...
  _handle = ctx.live.poll(ENDPOINT, 5000, (json, meta) => {
    // Dev7: replace with the real viz update. Honesty label is in meta.label.
