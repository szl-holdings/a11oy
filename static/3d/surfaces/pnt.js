...
//
// surfaces/pnt.js — PNT · Quantum Nav surface STUB (Dev0 foundation; Dev3 fills this).
//
// Leader/technique to model: Q-CTRL Ironstone Opal
// Primary live endpoint (doctrine: WIRE TO LIVE DATA, never fabricate): /api/a11oy/v1/pnt/sensor
//
...
//
// This STUB renders an honest "awaiting Dev3" placeholder + a LIVE badge wired to the
...
function mount(ctx) {
  ...
  h.textContent = TITLE + "  ·  awaiting Dev3";
  ...
  _handle = ctx.live.poll(ENDPOINT, 5000, (json, meta) => {
    // Dev3: replace with the real viz update. Honesty label is in meta.label.
