...
//
// surfaces/estate.js — Estate Hologram surface STUB (Dev0 foundation; Dev9 fills this).
//
// Leader/technique to model: Unified cross-tab overview
// Primary live endpoint (doctrine: WIRE TO LIVE DATA, never fabricate): /api/a11oy/v1/ecosystem/kpi-board
//
...
//
// This STUB renders an honest "awaiting Dev9" placeholder + a LIVE badge wired to the
// real endpoint, proving the toolkit primitives work end-to-end before the real viz lands.

const ID = "estate";
const TITLE = "Estate Hologram";
const ENDPOINT = "/api/a11oy/v1/ecosystem/kpi-board";
const ACCENT = 0x9fb1bf;
...
function mount(ctx) {
  ...
  h.textContent = TITLE + "  ·  awaiting Dev9";
  ...
  _handle = ctx.live.poll(ENDPOINT, 5000, (json, meta) => {
    // Dev9: replace with the real viz update. Honesty label is in meta.label.
