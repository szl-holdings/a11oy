...
//
// surfaces/fabric.js — Compute Fabric surface STUB (Dev0 foundation; Dev2 fills this).
//
// Leader/technique to model: NVIDIA Omniverse + 3d-force-graph
// Primary live endpoint (doctrine: WIRE TO LIVE DATA, never fabricate): /api/a11oy/v1/compute-pool
//
...
//
// This STUB renders an honest "awaiting Dev2" placeholder + a LIVE badge wired to the
...
function mount(ctx) {
  ...
  h.textContent = TITLE + "  ·  awaiting Dev2";
  ...
  _handle = ctx.live.poll(ENDPOINT, 5000, (json, meta) => {
    // Dev2: replace with the real viz update. Honesty label is in meta.label.
