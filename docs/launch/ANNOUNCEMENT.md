...
conformance profile**. It is not, and nothing here is, a blanket regulatory
compliance claim (CANON Law 10 wording rules; canonical list:
tools/docs_lexicon_gate.py). Applicability, classification, and deployer
obligations are customer-specific. A receipt format can make your logging conformant; it
