...
3. Review blocked, unsupported, and source-native assets. Planning performs no provider mutation, uses an anonymous public inventory, and needs no Hugging Face token.
