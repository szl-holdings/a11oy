...
`evidence/conformance/eu-ai-act-article-12.v1.yaml`, maps fields of the
...
NOT describe conformance to this specification with blanket compliance
phrasing (canonical banned list: tools/docs_lexicon_gate.py, CANON Law 10).
Applicability, high-risk classification, and deployer
...
4. **Blanket regulatory compliance claims.** Conformance support is limited
   to the Article 12 logging conformance profile (Section 8). Blanket
   compliance phrasing and equivalent marketing claims (canonical banned
   list: tools/docs_lexicon_gate.py, CANON Law 10) are prohibited
   descriptors of this format.
