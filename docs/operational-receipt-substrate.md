...
`artifacts/a11oy-uds/build/`, `artifacts/a11oy-uds/build-attestations/`,
and `dist/` are generated by the build script and intentionally ignored by git.
Run `scripts/validate-operational.sh` to regenerate and verify them from source.
