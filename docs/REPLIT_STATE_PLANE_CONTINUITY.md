...
`a1181f86-210d-4e5b-a612-a94c271366a7`. The task UI previously showed task 26
as complete. A fresh authorized connector inspection on 2026-07-22 returned a
`paused` phase with no source, runtime, test, preview, or deployment response.
No matching local export, Git remote, branch, commit, preview receipt, or
deployment receipt was found in this checkout.
