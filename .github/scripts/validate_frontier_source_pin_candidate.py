...
"""Validate an exact Frontier workflow repair using protected-base code only."""
...
SCHEMA: Final = "a11oy.frontier-source-pin-authority/v1"
MAX_FILE_BYTES: Final = 512_000
REPOSITORY: Final = "szl-holdings/a11oy"
WORKFLOW_FILE_PATH: Final = ".github/workflows/frontier-source-pin-authority.yml"
WORKFLOW_REF: Final = (
