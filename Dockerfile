...
# The formula registry verifies every pinned source asset while the guarded
# Brain/formula/constitution routes import. Keep the registry document and its
# evidence at the exact repo-relative paths expected by szl_formula_registry.
COPY formula_registry/formula-registry.v1.json ./formula_registry/formula-registry.v1.json
COPY corpus/formulas/lutar-lean__PROVEN_FORMULAS.md ./corpus/formulas/lutar-lean__PROVEN_FORMULAS.md
COPY proofs/lutar-lean/Lutar/Puriq/Formulas/PuriqFormulaLean.lean ./proofs/lutar-lean/Lutar/Puriq/Formulas/PuriqFormulaLean.lean
COPY proofs/lutar-lean/Lutar/Puriq/Formulas/ProvedFormulas.lean ./proofs/lutar-lean/Lutar/Puriq/Formulas/ProvedFormulas.lean
