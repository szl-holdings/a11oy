...
COPY policy/colang/roe_core.co policy/colang/killinchu_threat.co policy/colang/enforcement-contract.json ./policy/colang/
...
COPY gdw_attention.py gdw_auth.py gdw_workspace.py gdw_telemetry.py gdw_proofs.py gdw_runtime.py ./
