/**
 * qkan-fwp.ts — DARUAN activation + gated fast-weight programmer
 * Organ: amaru (HEART / SEQUENCE MEMORY)
 * Canonical home: amaru/web/src/lib/qkan-fwp/qkan-fwp.ts (this file)
 * Source: arXiv:2605.06734 (Peng et al., 2026) — Gated QKAN-FWP
 *         Nielsen & Chuang 2010, §4.2 — single-qubit rotations (Rx, Rz)
 * Author: Stephen P. Lutar Jr., SZL Holdings
 *
 * Distribution note (2026-05-28): this module was previously co-located only in
 * szl-cookbook/recipes/anatomy-evolved-v1/code/src/amaru-qkan-fwp.ts. The cookbook
 * file is now a tutorial fixture; this is the canonical implementation that
 * ch9 §9.1 names. Rx/Rz unitarity fix is per arXiv-reviewer-style audit
 * (correct N&C eq. 4.4/4.5 convention).
 */
