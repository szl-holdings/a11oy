...
# Purpose:       DSSE signing wrapper + Khipu DAG for amaru provenance.
# Key entry pts: sign_receipt(payload) -> signed dict
#                KhipuDAG.emit(action, payload) -> receipt with chain link
# Related mods:  szl_dsse.py (signing primitives), szl_khipu.py (DAG pattern)
# Doctrine note: COSE_Sign1 wrapping is amaru-specific; DSSE (szl_dsse.py)
#                is the a11oy-platform standard. Both use ECDSA-P256-SHA256.
# ---------------------------------------------------------------------------
