...
DOCTRINE = "v12"          # additive provenance surface (v12 = v11 + Puriq)
KERNEL_DOCTRINE = "v11"    # LOCKED Lean kernel doctrine — the proof substrate
KERNEL_COMMIT = "c7c0ba17" # LOCKED kernel SHA (749/14/163). Pinned into every receipt.
SLSA_LEVEL = "L1"
    ...
    def append_signed(self, receipt: dict[str, Any]) -> dict[str, Any]:
        ...
        with self.lock:
            ...
            node = {
                ...
                "slsa": SLSA_LEVEL,
                "doctrine": DOCTRINE,
                "kernel_doctrine": KERNEL_DOCTRINE,
...
def register_provenance(app, space: str) -> dict[str, Any]:
    ...
    def emit_signed_receipt(receipt: dict[str, Any], request=None) -> dict[str, Any]:
        ...
        r.setdefault("kernel_doctrine", KERNEL_DOCTRINE)
        r.setdefault("kernel_commit", KERNEL_COMMIT)
