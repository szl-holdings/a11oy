# API Contract — rosie v1.0
**Doctrine v11 LOCKED 749/14/163 | SLSA L1 honest | Version: 1.0.0**  
**Updated:** 2026-06-03

This document is the canonical API contract for the `rosie` flagship.
...
Every JSON response from `rosie` includes:
...
### GET `/api/rosie/v4/fleet` (a11oy only) / `/api/rosie/v1/brain` (amaru, rosie)
