...
The sentra HuggingFace Space and its GitHub-hosted source code under `szl-holdings/sentra`.
...
- **T-02**: Commit that modifies DOCTRINE constant to a non-v11 value
  - *Mitigation*: Branch protection requires CI pass; doctrine-grep.yml blocks stale-version patterns
...
- Doctrine-grep CI blocks overclaims (higher SLSA tiers, restricted-program, compliance-cert) — see .github doctrine-check.yml
