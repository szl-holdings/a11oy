...
| `source/` | README, roadmap, changelog, ecosystem OS, anatomy/formula map, autonomy doctrine, benchmark doctrine, investor demo, UDS gap map, ancient/source lineage, provenance contract. |
