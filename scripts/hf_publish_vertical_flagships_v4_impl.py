...
DOMAIN_HTML: dict[str, str] = {
    "terra": '''<div class="domain"><section class="panel parcel-map" aria-label="Illustrative parcel intelligence map"><div class="parcel p1">PARCEL A-14<br>OWNERSHIP 3 hops</div><div class="parcel p2">PARCEL B-07<br>DEBT watch</div><div class="parcel p3">PARCEL C-02<br>PIPELINE</div><div class="parcel p4">PARCEL D-11<br>REVIEW</div></section><aside class="panel dealstack"><div class="mono">UNDERWRITING QUEUE</div><div class="deal"><b>Ownership resolution</b><br><span>Evidence chain before outreach</span></div><div class="deal"><b>Basis / debt / distress</b><br><span>Separate observed facts from modeled value</span></div><div class="deal"><b>Human approval</b><br><span>No acquisition action without authority</span></div></aside></div>''',
