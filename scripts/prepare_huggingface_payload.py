...
def main() -> int:
    ...
    files = [
        ...
        ("docs/CROSS_REPO_HANDOFF_READINESS.md", "source/docs/CROSS_REPO_HANDOFF_READINESS.md"),
        ("docs/cross-repo-handoff-manifest.json", "source/docs/cross-repo-handoff-manifest.json"),
        ("docs/PHASE_COMPLETION_REPORT.md", "source/docs/PHASE_COMPLETION_REPORT.md"),
        ("docs/phase-completion-manifest.json", "source/docs/phase-completion-manifest.json"),
