...
SURFACES: List[Dict[str, str]] = [
    ...
    {"id": "circuits", "title": "Attribution Graph · Circuit Tracing", "owner": "WaveN-Dev4"},
    ...
    {"id": "sovereign", "title": "Sovereign Local Model · status · doctrine self-test · Stage A/B · signed receipt", "owner": "WaveM-Dev4"},
]
